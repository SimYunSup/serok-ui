import{j as p}from"./jsx-runtime-D_zvdyIk.js";import{f as I}from"./index-D_Ss_HUe.js";import{a as $}from"./index-D4lIrffr.js";import{i as g,x as r,d as s,b as C,S as w,n as d,c as y,P as D}from"./index-m4lUXf2c.js";import{C as B}from"./CheckboxMixin-Cmw4ZPho.js";import{t as a,I as h,s as n}from"./custom-tag-DQBYOfWA.js";import{e as j}from"./spectrum-icon-checkmark.css-Aj02uybc.js";const M=g`
...
`,U=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark75"}={})=>a`<svg
  ...
  >
    ...
    />
  </svg>`,E=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M3.667 9.07a.96.96 0 0 1-.737-.344L.753 6.114a.96.96 0 1 1 1.474-1.23l1.418 1.701 4.112-5.233a.96.96 0 0 1 1.51 1.186L4.422 8.704a.96.96 0 0 1-.741.367z"
    />
  </svg>`;class T extends h{render(){return n(r),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):E({hidden:!this.label,title:this.label})}}s("sp-icon-checkmark75",T);const H=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`,L=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M4.313 10.98a1.04 1.04 0 0 1-.8-.375L.647 7.165a1.042 1.042 0 0 1 1.6-1.333l2.042 2.45 5.443-6.928a1.042 1.042 0 0 1 1.64 1.287l-6.24 7.94a1.04 1.04 0 0 1-.804.399z"
    />
  </svg>`;class V extends h{render(){return n(r),this.spectrumVersion===2?H({hidden:!this.label,title:this.label}):L({hidden:!this.label,title:this.label})}}s("sp-icon-checkmark200",V);const A=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`,O=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M5.102 12.514a1.09 1.09 0 0 1-.834-.39L.988 8.19A1.085 1.085 0 0 1 2.656 6.8l2.421 2.906 6.243-7.947a1.085 1.085 0 0 1 1.707 1.34L5.955 12.1a1.09 1.09 0 0 1-.838.415z"
    />
  </svg>`;class S extends h{render(){return n(r),this.spectrumVersion===2?A({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}}s("sp-icon-checkmark300",S);const N=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,R=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M6.99 4.96H1.01a.96.96 0 0 1 0-1.92h5.98a.96.96 0 0 1 0 1.92" />
  </svg>`;class _ extends h{render(){return n(r),this.spectrumVersion===2?N({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}}s("sp-icon-dash75",_);const P=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash100"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,q=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash100"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M8.5 6h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2" />
  </svg>`;class F extends h{render(){return n(r),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):q({hidden:!this.label,title:this.label})}}s("sp-icon-dash100",F);const G=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,J=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M10.021 7.042H1.98a1.042 1.042 0 1 1 0-2.083h8.043a1.042 1.042 0 0 1 0 2.083z" />
  </svg>`;class K extends h{render(){return n(r),this.spectrumVersion===2?G({hidden:!this.label,title:this.label}):J({hidden:!this.label,title:this.label})}}s("sp-icon-dash200",K);const Q=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,W=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M10.61 7.085H1.39a1.085 1.085 0 0 1 0-2.17h9.22a1.085 1.085 0 0 1 0 2.17" />
  </svg>`;class X extends h{render(){return n(r),this.spectrumVersion===2?Q({hidden:!this.label,title:this.label}):W({hidden:!this.label,title:this.label})}}s("sp-icon-dash300",X);const Y=g`
...
`;var Z=Object.defineProperty,b=(e,o,c,t)=>{for(var l=void 0,m=e.length-1,v;m>=0;m--)(v=e[m])&&(l=v(o,c,l)||l);return l&&Z(o,c,l),l};const ee={s:()=>r`
            <sp-icon-checkmark75
                id="checkmark"
        ...
        `,xl:()=>r`
            ...
            ></sp-icon-dash300>
        `};let i=class extends C(B(w),{noDefaultSize:!0}){constructor(){super(...arguments),this.disabled=!1,this.indeterminate=!1,this.invalid=!1,this.emphasized=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.hasAttribute("autofocus")&&this.updateComplete.then(()=>{this.focus()})}static get styles(){return[M,j,Y]}click(){var o;this.disabled||(o=this.inputElement)==null||o.click()}handleChange(){this.indeterminate=!1,super.handleChange()}render(){return r`
            ${super.render()}
            <span id="box">
                ${this.checked?ee[this.size]():r``}
                ${this.indeterminate?oe[this.size]():r``}
            </span>
            <label id="label" for="input"><slot></slot></label>
        `}updated(o){super.updated(o),o.has("disabled")&&(typeof o.get("disabled")<"u"||this.disabled)&&(this.disabled?(this.inputElement.tabIndex=this.tabIndex,this.tabIndex=-1):(this.tabIndex=this.inputElement.tabIndex,this.inputElement.removeAttribute("tabindex")),this.inputElement.disabled=this.disabled),o.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate),o.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid"))}};i.shadowRootOptions={...w.shadowRootOptions,delegatesFocus:!0},b([d({type:Boolean,reflect:!0})],i.prototype,"disabled"),b([d({type:Boolean,reflect:!0})],i.prototype,"indeterminate"),b([d({type:Boolean,reflect:!0})],i.prototype,"invalid"),b([d({type:Boolean,reflect:!0})],i.prototype,"emphasized"),b([d({reflect:!0,type:Number,attribute:"tabindex"})],i.prototype,"tabIndex");s("sp-checkbox",i);const ce=y({displayName:"Checkbox",elementClass:i,react:$,tagName:"sp-checkbox",events:{change:"change"}});function z({variant:e,...o}){return p.jsx(ce,{...o,emphasized:e!=="default","data-variant":e})}z.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{variant:{required:!0,tsType:{name:"union",raw:'"default" | "accent" | "secondary"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"accent"'},{name:"literal",value:'"secondary"'}]},description:""}},composes:["Omit"]};const de={title:"Example/Checkbox",component:z,decorators:[e=>p.jsx(D,{children:p.jsx(e,{})})],parameters:{layout:"centered",expended:!0},tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"기본값"},size:{control:"select",options:["s","m","l","xl"],description:"버튼 크기"},indeterminate:{control:"boolean",description:"불확실한 상태"},invalid:{control:"boolean",description:"유효성 검사 실패 여부"},disabled:{control:"boolean",description:"비활성화 여부"},children:{control:"text",description:"체크박스 라벨"},variant:{control:"select",options:["default","accent","secondary"],description:"체크박스 색깔"},onChange:{action:"clicked",description:"값 변경 이벤트"}},args:{onChange:I()}},u={args:{size:"m",checked:!1,variant:"default",invalid:!1,disabled:!1,children:"Checkbox"}};var k,x,f;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    size: "m",
    checked: false,
    variant: "default",
...
}`,...(f=(x=u.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};const be=["Default"];export{u as Default,be as __namedExportsOrder,de as default};
