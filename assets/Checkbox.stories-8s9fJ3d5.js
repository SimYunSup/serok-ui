import{j as k}from"./jsx-runtime-D_zvdyIk.js";import{f as I}from"./index-D_Ss_HUe.js";import{a as C}from"./index-D4lIrffr.js";import{n as h,e as y,o as D,x as r,i as w,t as a,I as d,s as b,d as n,b as B,S as z,c as E,P as j}from"./index-CaKc-WKx.js";import{e as M}from"./spectrum-icon-checkmark.css-AXB_nNOg.js";var U=Object.defineProperty,p=(e,o,c,t)=>{for(var i=void 0,l=e.length-1,u;l>=0;l--)(u=e[l])&&(i=u(o,c,i)||i);return i&&U(o,c,i),i};function T(e){let o=class extends e{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}handleChange(){if(this.readonly){this.inputElement.checked=this.checked;return}this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return r`
                <input
                    id="input"
                ...
                />
            `}};return p([h({type:Boolean,reflect:!0})],o.prototype,"checked"),p([h({type:String,reflect:!0})],o.prototype,"name"),p([h({type:Boolean,reflect:!0})],o.prototype,"readonly"),p([y("#input")],o.prototype,"inputElement"),o}const H=w`
...
`,L=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark75"}={})=>a`<svg
  ...
  >
    ...
    />
  </svg>`,V=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M3.667 9.07a.96.96 0 0 1-.737-.344L.753 6.114a.96.96 0 1 1 1.474-1.23l1.418 1.701 4.112-5.233a.96.96 0 0 1 1.51 1.186L4.422 8.704a.96.96 0 0 1-.741.367z"
    />
  </svg>`;class A extends d{render(){return b(r),this.spectrumVersion===2?L({hidden:!this.label,title:this.label}):V({hidden:!this.label,title:this.label})}}n("sp-icon-checkmark75",A);const S=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`,O=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M4.313 10.98a1.04 1.04 0 0 1-.8-.375L.647 7.165a1.042 1.042 0 0 1 1.6-1.333l2.042 2.45 5.443-6.928a1.042 1.042 0 0 1 1.64 1.287l-6.24 7.94a1.04 1.04 0 0 1-.804.399z"
    />
  </svg>`;class N extends d{render(){return b(r),this.spectrumVersion===2?S({hidden:!this.label,title:this.label}):O({hidden:!this.label,title:this.label})}}n("sp-icon-checkmark200",N);const P=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`,R=({width:e=24,height:o=24,hidden:c=!1,title:t="Checkmark300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M5.102 12.514a1.09 1.09 0 0 1-.834-.39L.988 8.19A1.085 1.085 0 0 1 2.656 6.8l2.421 2.906 6.243-7.947a1.085 1.085 0 0 1 1.707 1.34L5.955 12.1a1.09 1.09 0 0 1-.838.415z"
    />
  </svg>`;class _ extends d{render(){return b(r),this.spectrumVersion===2?P({hidden:!this.label,title:this.label}):R({hidden:!this.label,title:this.label})}}n("sp-icon-checkmark300",_);const q=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,F=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash75"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M6.99 4.96H1.01a.96.96 0 0 1 0-1.92h5.98a.96.96 0 0 1 0 1.92" />
  </svg>`;class G extends d{render(){return b(r),this.spectrumVersion===2?q({hidden:!this.label,title:this.label}):F({hidden:!this.label,title:this.label})}}n("sp-icon-dash75",G);const J=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash100"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,K=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash100"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M8.5 6h-7a1 1 0 0 1 0-2h7a1 1 0 0 1 0 2" />
  </svg>`;class Q extends d{render(){return b(r),this.spectrumVersion===2?J({hidden:!this.label,title:this.label}):K({hidden:!this.label,title:this.label})}}n("sp-icon-dash100",Q);const W=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,X=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash200"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M10.021 7.042H1.98a1.042 1.042 0 1 1 0-2.083h8.043a1.042 1.042 0 0 1 0 2.083z" />
  </svg>`;class Y extends d{render(){return b(r),this.spectrumVersion===2?W({hidden:!this.label,title:this.label}):X({hidden:!this.label,title:this.label})}}n("sp-icon-dash200",Y);const Z=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  </svg>`,ee=({width:e=24,height:o=24,hidden:c=!1,title:t="Dash300"}={})=>a`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${c?"true":"false"}
    role="img"
  ...
  >
    <path d="M10.61 7.085H1.39a1.085 1.085 0 0 1 0-2.17h9.22a1.085 1.085 0 0 1 0 2.17" />
  </svg>`;class oe extends d{render(){return b(r),this.spectrumVersion===2?Z({hidden:!this.label,title:this.label}):ee({hidden:!this.label,title:this.label})}}n("sp-icon-dash300",oe);const ce=w`
...
`;var te=Object.defineProperty,m=(e,o,c,t)=>{for(var i=void 0,l=e.length-1,u;l>=0;l--)(u=e[l])&&(i=u(o,c,i)||i);return i&&te(o,c,i),i};const re={s:()=>r`
            <sp-icon-checkmark75
                id="checkmark"
        ...
        `,xl:()=>r`
            ...
            ></sp-icon-dash300>
        `};let s=class extends B(T(z),{noDefaultSize:!0}){constructor(){super(...arguments),this.disabled=!1,this.indeterminate=!1,this.invalid=!1,this.emphasized=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.hasAttribute("autofocus")&&this.updateComplete.then(()=>{this.focus()})}static get styles(){return[H,M,ce]}click(){var o;this.disabled||(o=this.inputElement)==null||o.click()}handleChange(){this.indeterminate=!1,super.handleChange()}render(){return r`
            ${super.render()}
            <span id="box">
                ${this.checked?re[this.size]():r``}
                ${this.indeterminate?ae[this.size]():r``}
            </span>
            <label id="label" for="input"><slot></slot></label>
        `}updated(o){super.updated(o),o.has("disabled")&&(typeof o.get("disabled")<"u"||this.disabled)&&(this.disabled?(this.inputElement.tabIndex=this.tabIndex,this.tabIndex=-1):(this.tabIndex=this.inputElement.tabIndex,this.inputElement.removeAttribute("tabindex")),this.inputElement.disabled=this.disabled),o.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate),o.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid"))}};s.shadowRootOptions={...z.shadowRootOptions,delegatesFocus:!0},m([h({type:Boolean,reflect:!0})],s.prototype,"disabled"),m([h({type:Boolean,reflect:!0})],s.prototype,"indeterminate"),m([h({type:Boolean,reflect:!0})],s.prototype,"invalid"),m([h({type:Boolean,reflect:!0})],s.prototype,"emphasized"),m([h({reflect:!0,type:Number,attribute:"tabindex"})],s.prototype,"tabIndex");n("sp-checkbox",s);const ie=E({displayName:"Checkbox",elementClass:s,react:C,tagName:"sp-checkbox",events:{change:"change"}});function $(e){return k.jsx(ie,{...e,emphasized:e.variant!=="default","data-variant":e.variant})}$.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{variant:{required:!0,tsType:{name:"union",raw:'"default" | "accent" | "secondary"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"accent"'},{name:"literal",value:'"secondary"'}]},description:""}}};const me={title:"Example/Checkbox",component:$,decorators:[e=>k.jsx(j,{children:k.jsx(e,{})})],parameters:{layout:"centered",expended:!0},tags:["autodocs"],argTypes:{checked:{control:"boolean",description:"기본값"},size:{control:"select",options:["s","m","l","xl"],description:"버튼 크기"},indeterminate:{control:"boolean",description:"불확실한 상태"},invalid:{control:"boolean",description:"유효성 검사 실패 여부"},disabled:{control:"boolean",description:"비활성화 여부"},children:{control:"text",description:"체크박스 라벨"},variant:{control:"select",options:["default","accent","secondary"],description:"체크박스 색깔"},onChange:{action:"clicked",description:"값 변경 이벤트"}},args:{onChange:I()}},v={args:{size:"m",checked:!1,variant:"default",invalid:!1,disabled:!1,children:"Checkbox"}};var x,f,g;v.parameters={...v.parameters,docs:{...(x=v.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    size: "m",
    checked: false,
    variant: "default",
...
}`,...(g=(f=v.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};const pe=["Default"];export{v as Default,pe as __namedExportsOrder,me as default};
