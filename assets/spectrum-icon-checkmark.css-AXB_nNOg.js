import{t as i,I as t,s as a,x as m,d as h,i as n}from"./index-CaKc-WKx.js";const o=({width:e=24,height:c=24,hidden:r=!1,title:s="Checkmark100"}={})=>i`<svg
  ...
  >
    ...
    />
  </svg>`,k=({width:e=24,height:c=24,hidden:r=!1,title:s="Checkmark100"}={})=>i`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r?"true":"false"}
    role="img"
  ...
  >
    <path
      d="M3.5 9.5a1 1 0 0 1-.774-.368l-2.45-3a1 1 0 1 1 1.548-1.264l1.657 2.028 4.68-6.01A1 1 0 0 1 9.74 2.114l-5.45 7a1 1 0 0 1-.777.386z"
    />
  </svg>`;class l extends t{render(){return a(m),this.spectrumVersion===2?o({hidden:!this.label,title:this.label}):k({hidden:!this.label,title:this.label})}}h("sp-icon-checkmark100",l);const u=n`
