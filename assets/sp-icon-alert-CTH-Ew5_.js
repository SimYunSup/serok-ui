import{I as n}from"./custom-tag-DQBYOfWA.js";import{x as o,d as h}from"./index-m4lUXf2c.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const A={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},f=t=>(...e)=>({_$litDirective$:t,values:e});class p{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,r,i){this._$Ct=e,this._$AM=r,this._$Ci=i}_$AS(e,r){return this.update(e,r)}update(e,r){return this.render(...r)}}function w(){return Array.from(crypto.getRandomValues(new Uint8Array(4)),t=>`0${(t&255).toString(16)}`.slice(-2)).join("")}let l;const a=function(t,...e){return l?l(t,...e):e.reduce((r,i,s)=>r+i+t[s+1],t[0])},c=t=>{l=t},d=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>a`<svg
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;class g extends n{render(){return c(o),this.spectrumVersion===1?d({hidden:!this.label,title:this.label}):u({hidden:!this.label,title:this.label})}}h("sp-icon-alert",g);export{f as e,p as i,w as r,A as t};
